...
08-28) and the owner has chosen the Nova/landing line instead. If the owner
still wants r2 live: **Themes → "GENERAL STORE — MASTER r2 (approved image
swaps)" → Publish**, then `docs/PRODUCTION-CUTOVER-PLAN.md`.

...
18 pages. Word counts are approximate (body text, excluding markup).

| Page | Handle | Pub | ~Words | Status |
|---|---|:--:|--:|---|
| **Size Guide — Women** | `size-guide-women` | ✅ | 620 | **NEW, final.** Body-vs-garment distinction, how-to-measure, bust/waist/hip cm+in, US/UK/EU/AU/JP |
| **Size Guide — Men** | `size-guide-men` | ✅ | 610 | **NEW, final.** Chest/waist/neck/sleeve/inseam cm+in, US/UK/EU/AU/JP |
| Our Mission | `about-us` | ✅ | ~450 | **Rewrite pending** — written for men's polos |
...
| Your Privacy Choices | `data-sharing-opt-out` | ✅ | ~120 | Keep |
| Google Site Verification | `google-site-verification` | ✅ | 1 line | **E9** — publicly published, 1 line. Should be unpublished |
| Size Guide — Men's Polos | `size-guide` | ✅ | ~700 | **Superseded** by the two new guides. Retire + redirect |
| Size Chart | `size-chart` | ❌ | ~300 | **Superseded.** Delete |
| Voltcore 2-Piece Set | `voltcore` | ❌ | ~350 | Orphan. Delete or repurpose |
| Fabric Weight Index | `fabric-weight-index` | ❌ | ~200 | Orphan, references 109 products that no longer exist. Delete |

**Not created:** Care Guide (queue item 10) — deferred, since the fabric types
it must cover are determined by the catalog.
